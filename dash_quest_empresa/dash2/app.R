      ...
      tabItem(tabName = "dashboard",
              ...
              fluidRow(
                ...
                box(title = "Recomendações",
                    HTML("<p>Os clientes apreciam bastante a variedade de sabores de milkshake, recomendamos investir em experimentações e sabores sazonais<p/>
                         <br>
                         <p>Existe uma demanda de reserva online<p/>
                         <br>
                         <p>Existe uma demanda em diminuir o tempo de espera, recomendamos o treinamento de comunicação eficiente, gestão de tempo e trabalho em equipe<p/>")  ,
